...
model_hypothesis_a = ols(
    'abs_diff_belief_prob ~   C(treatment, Treatment(reference="baseline")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df).fit(cov_type="HC0")

# simple difference, not absolute difference with vars

model_hypothesis_a_true_diff = ols(
    'diff_belief_prob ~   C(treatment, Treatment(reference="baseline")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint ', data=df).fit(cov_type="HC0")

# small probabilities

model_hypothesis_a_prob_20 = ols(
    'abs_diff_belief_prob ~   C(treatment, Treatment(reference="baseline")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint ', data=df.loc[df['prob']<0.2]).fit(cov_type="HC0")


model_hypothesis_a_true_diff_prob_20 = ols(
    'diff_belief_prob ~   C(treatment, Treatment(reference="baseline")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint ', data=df.loc[df['prob']<0.2]).fit(cov_type="HC0")

# big probabilities

model_hypothesis_a_prob_80 = ols(
    'abs_diff_belief_prob ~   C(treatment, Treatment(reference="baseline")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint ', data=df.loc[df['prob']>0.8]).fit(cov_type="HC0")


model_hypothesis_a_true_diff_prob_80 = ols(
    'diff_belief_prob ~   C(treatment, Treatment(reference="baseline")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint ', data=df.loc[df['prob']>0.8]).fit(cov_type="HC0")
...
model_hypothesis_b = ols('WTP ~   C(treatment, Treatment(reference="varinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df).fit(cov_type="HC0")
model_hypothesis_b_20 = ols('WTP ~   C(treatment, Treatment(reference="varinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['prob']<0.2]).fit(cov_type="HC0")
model_hypothesis_b_80 = ols('WTP ~   C(treatment, Treatment(reference="varinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['prob']>0.8]).fit(cov_type="HC0")

model_hypothesis_b_overestimator = ols('WTP ~   C(treatment, Treatment(reference="varinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['diff_belief_prob']>0]).fit(cov_type="HC0")
model_hypothesis_b_underestimator = ols('WTP ~   C(treatment, Treatment(reference="varinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['diff_belief_prob']<0]).fit(cov_type="HC0")


summary_col([model_hypothesis_b, model_hypothesis_b_20, model_hypothesis_b_80, model_hypothesis_b_overestimator, model_hypothesis_b_underestimator],stars=True,float_format='%0.2f')

# with open('ols_s8_to_s17/wtp_230225.txt', 'w') as f:
#     f.write(summary_col([model_hypothesis_b, model_hypothesis_b_20, model_hypothesis_b_80, model_hypothesis_b_overestimator, model_hypothesis_b_underestimator],stars=True,float_format='%0.2f').as_latex())
#     f.close()
...
df = df.assign(insurance_takeup_fair=[0 for i in range(len(df))])
df = df.assign(insurance_takeup_belief=[0 for i in range(len(df))])

df['belief_over_100'] = df['belief']/100

df['insurance_takeup'].mask((df['WTP'] > df['insurance']), 1, inplace=True)
df['insurance_takeup_fair'].mask((df['WTP'] > df['loss_amount']*df['prob']), 1, inplace=True)
df['insurance_takeup_belief'].mask((df['WTP'] > df['loss_amount']*df['belief_over_100']), 1, inplace=True)

#%
model_takeup_f = probit('insurance_takeup_fair ~   C(treatment, Treatment(reference="fullinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df).fit(cov_type="HC0")
model_takeup_b = probit('insurance_takeup_belief ~   C(treatment, Treatment(reference="fullinfo")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df).fit(cov_type="HC0")
# insignificant for below
# model_takeup_20 = probit('insurance_takeup_belief ~   C(treatment, Treatment(reference="fullinfo")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['prob']<0.2]).fit(cov_type="HC0")
# model_takeup_80 = probit('insurance_takeup_belief ~   C(treatment, Treatment(reference="fullinfo")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['prob']>0.8]).fit(cov_type="HC0")
model_takeup_overestimator_f = probit('insurance_takeup_fair ~   C(treatment, Treatment(reference="fullinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['diff_belief_prob']>0]).fit(cov_type="HC0")
model_takeup_overestimator_b = probit('insurance_takeup_belief ~   C(treatment, Treatment(reference="fullinfo")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['diff_belief_prob']>0]).fit(cov_type="HC0")

model_takeup_underestimator_b = probit('insurance_takeup_belief ~   C(treatment, Treatment(reference="fullinfo")) + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['diff_belief_prob']<0]).fit(cov_type="HC0")
model_takeup_underestimator_f = probit('insurance_takeup_fair ~   C(treatment, Treatment(reference="fullinfo")) + belief + var1 + var2 + var3 + var4 + timer_all_chars + round_number + loss_amount + number_entered + HL_switchpoint', data=df.loc[df['diff_belief_prob']<0]).fit(cov_type="HC0")

summary_col([model_takeup_f, model_takeup_overestimator_f, model_takeup_underestimator_f, model_takeup_b, model_takeup_overestimator_b, model_takeup_underestimator_b],stars=True,float_format='%0.2f')

with open('ols_s8_to_s17/takeup_230225.txt', 'w') as f:
    f.write(summary_col([model_takeup_f, model_takeup_overestimator_f, model_takeup_underestimator_f, model_takeup_b, model_takeup_overestimator_b, model_takeup_underestimator_b],stars=True,float_format='%0.2f').as_latex())
    f.close()
